...
#include <sensor_fusion/SetDepthOffset.h>
#include <sensor_fusion/SetWorldXYOffset.h>
...
public:
    ...
    bool SetDepthOffsetCallback(sensor_fusion::SetDepthOffset::Request &rqst, sensor_fusion::SetDepthOffset::Response &response);
    bool SetWorldXYOffsetCallback(sensor_fusion::SetWorldXYOffset::Request &rqst, sensor_fusion::SetWorldXYOffset::Response &response);
