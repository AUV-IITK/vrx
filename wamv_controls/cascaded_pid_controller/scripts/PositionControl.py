...
from cascaded_pid_controller.cfg import PositionControlConfig
...
class PositionControllerNode:
    def __init__(self):
        ...
        # ROS infrastructure
        self.sub_cmd_pose = rospy.Subscriber('/wamv/cmd_pose', numpy_msg(geometry_msgs.Pose), self.cmd_pose_callback)
        self.sub_odometry = rospy.Subscriber('/wamv/pose_gt', numpy_msg(Odometry), self.odometry_callback)
        self.pub_cmd_vel = rospy.Publisher('/wamv/cmd_vel', geometry_msgs.Twist, queue_size=10)
